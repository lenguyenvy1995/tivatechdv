<section class=" shortcode-site-statistics-style-2 shortcode-site-statistics shortcode-tivatech" @style($variablesStyle)>
    <div class="container">
            ...
            <div class="col-xl-8 col-lg-8">
                <div class="section-title text-center mb-40 tg-heading-subheading animation-style3">
                    ...
                    @if (($buttonLabel = $shortcode->button_label) && ($buttonUrl = $shortcode->button_url))
                        <a href="{{ $buttonUrl }}" class="btn" data-aos="fade-up" data-aos-delay="600">
